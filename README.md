...
Semantic Html are html tags that give meaning to what they are grouped with.

2. Name two big differences between ```display: block;``` and ```display: inline;``` 
display:block; takes up its level of the page and breaks off a new line when it ends. display:inline; is used to take up as much space necessary and no more.

3. What are the 4 areas of the box model?
From outer layer to inner it is : Margin, Border, Padding, Content.
...
Git is valuable because everyone on the team can branch off from the origin and work on what they need, and they can come together and pull each persons code back to the origin and have their higher ups check them easily.
